module Binda
  class Repeater < ApplicationRecord
    ...
    has_many :children_fieldables, through: :passive_relationships, source_type: "Binda::Repeater"
    # source: :parent_fieldable matches with the belong_to :children_fieldable identification in the Association model
    has_many :parent_fieldables, through: :active_relationships, source_type: "Binda::Repeater"
